...
st.title(':green[Customer Segmentation Application]')
...
if submit:
    prediction=model.predict([[age,education_qual,day,dur,num_calls,job_admin,job_blue_collar,job_entrepreneur,job_housemaid,job_management,
                               job_retired,job_self_employed,job_services,job_student,job_technician,job_unemployed,marital_divorced,marital_married,
